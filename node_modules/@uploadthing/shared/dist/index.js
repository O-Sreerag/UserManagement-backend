...
function generateUploadThingURL(path) {
  ...
  if (import_std_env.process.env.CUSTOM_INFRA_URL) {
    host = import_std_env.process.env.CUSTOM_INFRA_URL;
  }
  return `${host}${path}`;
}
...
var UploadThingError = class extends Error {
  ...
  constructor(initOpts) {
    const opts = typeof initOpts === "string" ? { code: "INTERNAL_SERVER_ERROR", message: initOpts } : initOpts;
