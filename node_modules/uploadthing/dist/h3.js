...
var createRouteHandler = (opts) => {
  ...
  return (0, import_h3.defineEventHandler)(async (event) => {
    ...
    (0, import_h3.setHeader)(event, "x-uploadthing-version", UPLOADTHING_VERSION);
    if (event.method === "GET") {
      return getBuildPerms();
    }
    const response = await requestHandler({
      nativeRequest: (0, import_h3.toWebRequest)(event),
      event,
      originalRequest: void 0,
      res: void 0
    });
    if (response instanceof import_shared4.UploadThingError) {
      (0, import_h3.setResponseStatus)(event, (0, import_shared4.getStatusCodeFromError)(response));
